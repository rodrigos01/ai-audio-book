...
Respond with your line of speech and whether you think the episode should end after this turn (it \
shouldn't — you're opening it).`;
}
...
response on its own — it doesn't need to add new information every time. Set "endEpisode" to true only if \
you are a host and this is a natural, satisfying place to close the episode.`;
}
